...
save_path = os.path.join(os.path.dirname(__file__), "custom_model_MobileBERT")
...
inputs = tokenizer(sentences, truncation=True, max_length=256, padding="max_length", return_tensors='pt')
