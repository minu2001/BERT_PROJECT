...
save_path = os.path.join(os.path.dirname(__file__), "custom_model_DeBERTa")
...
scheduler = get_linear_schedule_with_warmup(optimizer, 0, len(train_loader) * 8)
